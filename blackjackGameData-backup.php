                  ...
                  if ( mysqli_num_rows($resultm1) > 0 )
                  {
                      ...
                      elseif ( $blackjackstatus == 1 )
                      {
                          ...
                          if ( ( strtotime($blackjacktime) - time()) > 0 )
                          {
                              ...
                              // check  if this time remaining is 10 seconds remaining 
                              if ( (strtotime($blackjacktime) - time()) > 10 )
                              {
                      ...
                      elseif ( $blackjackstatus == 2 )
                      {
                          ...
                          if ( mysqli_num_rows($resultn1) > 0 )
                          {
                              ...
                              else
                              {
                                  ...
                                  else
                                  {
                                      // start a new session
                                      //renew session
                                      if ( (strtotime($blackjacktime) - time() + ( $playerstoskip2 * 20)) > 0 )
                                          doblackjackcalculations($sessionid, $dbc, TRUE);
                                      else
                                          doblackjackcalculations($sessionid, $dbc);
                          ...
                          {
                              $query3 = "select user_id, player_status from blackjack_bets where player_status like '%0%' and session_id = $sessionid and amount != '0' and cards != '' order by datetime limit 1";
                              ...
                              if ( mysqli_num_rows($result3) > 0 )
                              {
                                  ...
                                  for ( $i = 0; $i < $thisplayerstatusexploded; $i++ )
                                  {
                                      if ( $thisplayerstatusexploded[$i] == 0 )
                                      {
                                          ...
                                          $query4 = "update blackjack_bets set player_status = '$playerstatus' where user_id = $thisuserid and session_id = $sessionid";
                      ...
                      elseif ( $blackjackstatus == 3 )
                      {
                          ...
                          // check if status of dealer is zero
