              ...
              else
              {
                  ...
                  if ( mysqli_num_rows($resultm1) > 0 )
                  {
                      ...
                      if ( $blackjackstatus == 0 )
                      {
                          ...
                          if ( givecardstoall($dbc, $sessionid) )
                          {
                      ...
                      elseif ( $blackjackstatus == 1 )
                      {
                          ...
                          if ( ( strtotime($blackjacktime) - time()) > 0 )
                          {
                              ...
                              // if came before 20 seconds, 
                              if ( ( strtotime($blackjacktime) - time()) > 10 )
                                  givecardstolatecomers($sessionid, $dbc);
                          }
                          else
                          {
                              ...
                              $querym1 = "select * from blackjack_bets where session_id = $sessionid and amount != '0' and cards !='' and user_id != 0 order by datetime";
                              $resultm1 = mysqli_query($dbc, $querym1);
...
//                              
          ...
          if ( mysqli_num_rows($result2) != 0 )
          {
              ...
              $query = "select user_details.user_id,games_players.status,invitations.status, name, gold, chips, icon_name, blackjack_bets.player_status, cards, amount
              from 
